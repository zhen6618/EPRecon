...
def parse_args():
    ...
    parser.add_argument("--model", metavar="FILE",
                        ...
                        default="results/scene_scannet_checkpoints_fusion_eval_48")
    parser.add_argument('--max_depth', default=10., type=float,
                        help='mask out large depth values since they are noisy')
    parser.add_argument("--data_path", metavar="DIR",
                        help="path to dataset", default='/data/zz_data/Project/Panoptic_Reconstruction/ScanNetV2_reader/scans_test')
    parser.add_argument("--gt_path", metavar="DIR",
                        help="path to raw dataset", default='/data/zz_data/Project/Panoptic_Reconstruction/ScanNetV2_ply')
...
def process(scene, total_scenes_index, total_scenes_count):
    ...
    # eval trimed mesh
    file_mesh_trgt = os.path.join(args.gt_path, scene + '_vh_clean_2.ply')
